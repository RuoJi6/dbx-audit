...
import { DatabaseZap, FilePlus2, Loader2, Languages, Moon, Sun, SunMoon, History, Bot, ArrowLeftRight, FileCode, FileStack, GitCompareArrows, TableProperties, ShieldCheck, Settings, CloudDownload, Package, Ellipsis } from "@lucide/vue";
...
const collapsedItems = computed(() => [
  ...
  {
    value: "audit",
    label: t("audit.toolbar"),
    icon: ShieldCheck,
    action: () => emit("toggle-audit"),
    disabled: !props.hasConnections,
  },
  {
    value: "driver-store",
