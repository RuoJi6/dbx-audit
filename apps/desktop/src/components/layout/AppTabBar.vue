            ...
            <Tooltip>
              <TooltipTrigger as-child>
                <div
                  ...
                  :class="
                    settingsStore.editorSettings.appLayout === 'classic'
                      ? [compactTabTitle ? 'min-w-24' : 'min-w-38', 'h-full border-r border-border/80 font-medium dark:border-border/45', tab.id === queryStore.activeTabId && !showDriverStore && !showAuditPanel ? 'bg-background text-foreground' : 'text-foreground/70 hover:text-foreground/90']
                      : [compactTabTitle ? 'min-w-24' : 'min-w-38', 'h-7 rounded-md border', tab.id === queryStore.activeTabId && !showDriverStore && !showAuditPanel ? 'text-foreground font-medium' : 'border-border/60 text-foreground/70 hover:border-border hover:text-foreground/90']
                  "
