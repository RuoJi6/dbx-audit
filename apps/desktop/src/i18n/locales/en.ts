export default {
  ...
  audit: {
    ...
    subtitle: "Sensitive data discovery and auditing for DBX connections",
    connection: "Connection",
    selectConnection: "Select connection",
    database: "Database",
    databasePlaceholder: "audit_demo",
    databaseHint: "If empty, DBX uses the connection default database or enumerates accessible databases.",
    schema: "Schema",
    schemaPlaceholder: "public / dbo / empty",
    tables: "Tables",
    tablesPlaceholder: "users, orders; leave empty to scan all tables",
    modeLabel: "Scan mode",
    levelLabel: "Risk level",
    sampleLimit: "Sample limit",
    maskSamples: "Mask samples in reports",
    start: "Start scan",
    cancel: "Cancel scan",
    ...
    log: {
      ...
      completed: "Audit scan completed",
      cancelled: "Audit scan cancelled",
      enumeratingDatabases: "Database is empty; enumerating accessible databases",
      inspectingMetadata: "Inspecting schema metadata for {database}",
      scannedTable: "Scanned table {table}",
    },
    validation: {
      running: "A scan is already running",
