export default {
  ...
  audit: {
    ...
    subtitle: "Rilevamento e audit dei dati sensibili per le connessioni DBX",
    connection: "Connessione",
    selectConnection: "Seleziona connessione",
    database: "Database",
    databasePlaceholder: "audit_demo",
    databaseHint: "Se vuoto, DBX usa il database predefinito o enumera i database accessibili.",
    schema: "Schema",
    schemaPlaceholder: "public / dbo / vuoto",
    tables: "Tabelle",
    tablesPlaceholder: "users, orders; lascia vuoto per scansionare tutte",
    modeLabel: "Modalità scansione",
    levelLabel: "Livello di rischio",
    sampleLimit: "Limite campioni",
    overview: "Pannello attività",
    overviewHeadline: "Crea un'attività e configura i target di scansione; consulta i risultati nel dettaglio.",
    ...
    noDescription: "Nessun dettaglio attività",
    ...
    delete: "Elimina",
    workers: "Concorrenza",
    targetWorkers: "Concorrenza target",
    ...
    connectionResultOverview: "Riepilogo connessioni",
    noHits: "Nessun risultato",
    hasHits: "Con risultati",
    outputEnabled: "Esporta tabella",
    splitOutput: "Dividi output per target",
    includeSystem: "Includi database di sistema",
    encoding: "Codifica",
    hitTables: "Tabelle colpite",
    sensitiveFields: "Campi sensibili",
    highRiskHits: "Alto rischio",
    currentProgress: "Avanzamento",
    createdAt: "Creato",
    updatedAt: "Aggiornato",
    maskSamples: "Maschera i campioni nei report",
    start: "Avvia scansione",
    cancel: "Annulla scansione",
    exportPath: "Percorso esportazione",
    exportPlaceholder: "dbx-audit-report.xlsx",
    fscanText: "Testo fscan",
    parse: "Analizza",
    parsedTargets: "{count} target database analizzati.",
    findings: "Risultati",
    table: "Tabella",
    column: "Colonna / Key",
    kindLabel: "Tipo",
    levelColumn: "Livello",
    basisLabel: "Base",
    noFindings: "Nessun risultato ancora.",
    logs: "Log",
    log: {
      queued: "Scansione audit in coda",
      completed: "Scansione audit completata",
      cancelled: "Scansione audit annullata",
      enumeratingDatabases: "Database vuoto; enumerazione dei database accessibili",
      inspectingMetadata: "Ispezione metadati schema per {database}",
      scannedTable: "Tabella scansionata {table}",
    },
    validation: {
      running: "Una scansione è già in esecuzione",
      selectConnection: "Seleziona una connessione",
      databaseRequired: "Inserisci il nome del database",
    },
    status: {
      idle: "Inattivo",
      running: "In esecuzione",
    ...
    kind: {
      phone: "Telefono",
      email: "Email",
      "id-card": "Documento identità",
      "bank-card": "Carta bancaria",
      "password-secret": "Password / segreto",
      "token-secret": "Token / chiave",
      address: "Indirizzo",
      username: "Nome utente",
      account: "Account",
      "ip-address": "Indirizzo IP",
      "business-identifier": "ID business",
      "risk-evidence": "Rischio/evidenza",
    },
    basis: {
      "field-name": "Nome campo",
      "field-content": "Campo + contenuto",
