...
export default withEnglishFallback({
  ...
  audit: {
    toolbar: "审计",
    title: "安全审计",
    subtitle: "对 DBX 连接进行敏感信息扫描与审计",
    connection: "连接",
    selectConnection: "选择连接",
    database: "数据库",
    databasePlaceholder: "audit_demo",
    databaseHint: "留空时会使用连接默认数据库；没有默认库时自动枚举可访问数据库。",
    schema: "Schema / 模式",
    schemaPlaceholder: "public / dbo / 留空",
    tables: "表",
    tablesPlaceholder: "users, orders；留空扫描全部表",
    modeLabel: "扫描模式",
    levelLabel: "风险级别",
    sampleLimit: "样例数量",
    maskSamples: "报告中脱敏样例",
    ...
    log: {
      ...
      completed: "审计扫描已完成",
      cancelled: "审计扫描已取消",
      enumeratingDatabases: "数据库为空，正在枚举可访问数据库",
      inspectingMetadata: "正在读取数据库元数据：{database}",
      scannedTable: "已扫描表：{table}",
    },
    validation: {
      running: "扫描任务正在运行",
      selectConnection: "请选择一个连接",
      databaseRequired: "请填写数据库名",
    },
    status: {
      idle: "待命",
      running: "扫描中",
