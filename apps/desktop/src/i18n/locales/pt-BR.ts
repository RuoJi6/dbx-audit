export default {
  ...
  audit: {
    ...
    subtitle: "Descoberta e auditoria de dados sensíveis para conexões DBX",
    connection: "Conexão",
    selectConnection: "Selecionar conexão",
    database: "Banco de dados",
    databasePlaceholder: "audit_demo",
    databaseHint: "Se vazio, o DBX usa o banco padrão da conexão ou enumera bancos acessíveis.",
    schema: "Schema",
    schemaPlaceholder: "public / dbo / vazio",
    tables: "Tabelas",
    tablesPlaceholder: "users, orders; deixe vazio para escanear todas",
    modeLabel: "Modo de varredura",
    levelLabel: "Nível de risco",
    sampleLimit: "Limite de amostras",
    overview: "Painel de tarefas",
    overviewHeadline: "Crie uma tarefa e configure os alvos de varredura; veja os resultados no detalhe.",
    newTask: "Nova tarefa",
    ...
    noDescription: "Sem detalhes da tarefa",
    ...
    targetWorkers: "Concorrência de alvos",
    ...
    connectionResultOverview: "Resumo por conexão",
    noHits: "Sem achados",
    hasHits: "Com achados",
    outputEnabled: "Exportar tabela",
    splitOutput: "Dividir saída por alvo",
    includeSystem: "Incluir bancos do sistema",
    encoding: "Codificação",
    hitTables: "Tabelas atingidas",
    sensitiveFields: "Campos sensíveis",
    highRiskHits: "Alto risco",
    currentProgress: "Progresso atual",
    createdAt: "Criado",
    updatedAt: "Atualizado",
    maskSamples: "Mascarar amostras nos relatórios",
    ...
    levelColumn: "Nível",
    basisLabel: "Base",
    noFindings: "Ainda não há achados.",
    logs: "Logs",
    log: {
      queued: "Varredura de auditoria na fila",
      completed: "Varredura de auditoria concluída",
      cancelled: "Varredura de auditoria cancelada",
      enumeratingDatabases: "Banco vazio; enumerando bancos acessíveis",
      inspectingMetadata: "Inspecionando metadados de schema para {database}",
      scannedTable: "Tabela escaneada {table}",
    },
    validation: {
      running: "Uma varredura já está em execução",
      selectConnection: "Selecione uma conexão",
      databaseRequired: "Informe o nome do banco de dados",
    },
    status: {
      idle: "Ocioso",
      running: "Em execução",
    ...
    kind: {
      ...
      "password-secret": "Senha / segredo",
      "token-secret": "Token / chave",
      address: "Endereço",
      username: "Nome de usuário",
      account: "Conta",
      "ip-address": "Endereço IP",
      "business-identifier": "ID de negócio",
      "risk-evidence": "Risco/evidência",
    },
    basis: {
      "field-name": "Nome do campo",
      "field-content": "Campo + conteúdo",
