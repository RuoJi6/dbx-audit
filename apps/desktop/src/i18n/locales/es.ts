export default {
  ...
  audit: {
    ...
    subtitle: "Descubrimiento y auditoría de datos sensibles para conexiones DBX",
    connection: "Conexión",
    selectConnection: "Seleccionar conexión",
    database: "Base de datos",
    databasePlaceholder: "audit_demo",
    databaseHint: "Si está vacío, DBX usa la base predeterminada o enumera las bases accesibles.",
    schema: "Schema",
    schemaPlaceholder: "public / dbo / vacío",
    tables: "Tablas",
    tablesPlaceholder: "users, orders; dejar vacío para escanear todas",
    modeLabel: "Modo de escaneo",
    levelLabel: "Nivel de riesgo",
    sampleLimit: "Límite de muestras",
    overview: "Panel de tareas",
    overviewHeadline: "Crea una tarea y configura los objetivos de escaneo; revisa los resultados en el detalle.",
    newTask: "Nueva tarea",
    ...
    failed: "Fallidas",
    taskInfo: "Información de tarea",
    noDescription: "Sin detalles de tarea",
    ...
    targetWorkers: "Concurrencia de objetivos",
    ...
    connectionResultOverview: "Resumen por conexión",
    noHits: "Sin hallazgos",
    hasHits: "Con hallazgos",
    outputEnabled: "Exportar tabla",
    splitOutput: "Separar salida por objetivo",
    includeSystem: "Incluir bases del sistema",
    encoding: "Codificación",
    hitTables: "Tablas con hallazgos",
    sensitiveFields: "Campos sensibles",
    highRiskHits: "Alto riesgo",
    currentProgress: "Progreso actual",
    createdAt: "Creado",
    updatedAt: "Actualizado",
    maskSamples: "Enmascarar muestras en reportes",
    ...
    logs: "Registros",
    log: {
      queued: "Escaneo de auditoría en cola",
      completed: "Escaneo de auditoría completado",
      cancelled: "Escaneo de auditoría cancelado",
      enumeratingDatabases: "La base está vacía; enumerando bases accesibles",
      inspectingMetadata: "Inspeccionando metadatos de esquema para {database}",
      scannedTable: "Tabla escaneada {table}",
    },
    validation: {
      running: "Ya hay un escaneo en ejecución",
      selectConnection: "Selecciona una conexión",
      databaseRequired: "Introduce un nombre de base de datos",
    },
    status: {
      idle: "Inactivo",
      running: "En ejecución",
    ...
    kind: {
      ...
      "password-secret": "Contraseña / secreto",
      "token-secret": "Token / clave",
      address: "Dirección",
      username: "Usuario",
      account: "Cuenta",
