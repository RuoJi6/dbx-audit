...
export default withEnglishFallback({
  ...
  audit: {
    toolbar: "審計",
    title: "安全審計",
    subtitle: "對 DBX 連線進行敏感資訊掃描與審計",
    connection: "連線",
    selectConnection: "選擇連線",
    database: "資料庫",
    databasePlaceholder: "audit_demo",
    databaseHint: "留空時會使用連線預設資料庫；沒有預設資料庫時自動列舉可存取資料庫。",
    schema: "Schema / 模式",
    schemaPlaceholder: "public / dbo / 留空",
    tables: "資料表",
    tablesPlaceholder: "users, orders；留空掃描全部資料表",
    modeLabel: "掃描模式",
    levelLabel: "風險級別",
    sampleLimit: "樣本數量",
    overview: "任務工作台",
    overviewHeadline: "新建任務後再設定掃描目標，結果進入任務詳情查看。",
    newTask: "新建任務",
    taskList: "任務列表",
    allTasks: "全部任務",
    running: "執行中",
    ...
    singleTargetConcurrency: "單目標",
    multiTargetSequential: "{count} 個目標順序執行",
    outputFiles: "輸出檔案",
    connectionResultOverview: "連線結果概覽",
    noHits: "無命中",
    hasHits: "有命中",
    outputEnabled: "輸出表格",
    splitOutput: "按目標拆分輸出",
    ...
    log: {
      ...
      completed: "審計掃描已完成",
      cancelled: "審計掃描已取消",
      enumeratingDatabases: "資料庫留空，正在列舉可存取資料庫",
      inspectingMetadata: "正在讀取資料庫元資料：{database}",
      scannedTable: "已掃描資料表：{table}",
    },
    validation: {
      running: "掃描任務正在執行",
      selectConnection: "請選擇一個連線",
      databaseRequired: "請填寫資料庫名稱",
    },
    status: {
      idle: "待命",
      running: "掃描中",
